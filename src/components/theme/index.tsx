...
import { getMatchingGrayColor, type ComponentPropsWithout, type RemovedProps } from '@helpers';
import { themePropDefs, type ThemeOwnProps } from './theme.props';
...
type ThemeImplElement = HTMLDivElement;
